...
var { JsonServiceClient, Authenticate, $1, map, leftPart } = exports
...
client.api(new Authenticate())
    .then(api => {
        if (api.succeeded) {
            AUTH = api.response
            $1('#signin').innerHTML = `<a href="/profile" class="block mx-3 relative">
            ...
            AUTH = null
            $1('#signin').innerHTML = `<a href="/signin" class="m-2">
