...
##  [/BlazorAiGallery.Client](https://github.com/NetCoreTemplates/blazor-tailwind/tree/main/BlazorAiGallery.Client)
...
## [/BlazorAiGallery](https://github.com/NetCoreTemplates/blazor-tailwind/tree/main/BlazorAiGallery)

The .NET 6 `/BlazorAiGallery` backend server is required for this App's dynamic functions including the Hello API on the home page
